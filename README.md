...
ChemEquivMapper is a Python package that improves metabolite-to-pathway mapping in metabolomics studies by leveraging the ChEBI ontology to resolve semantic and chemical specificity mismatches between analytical annotations and pathway databases such as Reactome and KEGG.
